...
<body>
    ...
    <main>
        ...
        <box>
            <div class="page">
                <div class="titolo">
                    <?php foreach ($faqs as $domanda) { ?>
                        <h3><?php echo "{$domanda["domanda"]}"; ?></h3>
                    <?php } ?>
                </div>

                <div class="paragrafo">
                    <?php foreach ($faqs as $risposta) { ?>
                        <p><?php echo "{$risposta["risposta"]}"; ?></p>
                    <?php } ?>
                </div>

                <div class="titolo">
                    <?php foreach ($faqsDue as $domanda) { ?>
                        <h3><?php echo "{$domanda["domanda"]}"; ?></h3>
                    <?php } ?>
                </div>

                <div class="paragrafo">
                    <?php foreach ($faqsDue as $risposta) { ?>
                        <p><?php echo "{$risposta["risposta"]}"; ?></p>
                    <?php } ?>
                </div>

                <div class="titolo">
                    <?php foreach ($faqsTre as $domanda) { ?>
                        <h3><?php echo "{$domanda["domanda"]}"; ?></h3>
                    <?php } ?>
                </div>

                <div class="paragrafo">
                    <?php foreach ($faqsTre as $risposta) { ?>
                        <p><?php echo "{$risposta["risposta"]}"; ?></p>
                    <?php } ?>
                </div>

                <div class="titolo">
                    <?php foreach ($faqsQuattro as $domanda) { ?>
                        <h3><?php echo "{$domanda["domanda"]}"; ?></h3>
                    <?php } ?>
                </div>

                <div class="paragrafo">
                    <?php foreach ($faqsQuattro as $risposta) { ?>
                        <p><?php echo "{$risposta["risposta"]}"; ?></p>
                    <?php } ?>
                </div>

                <div class="titolo">
                    <?php foreach ($faqsCinque as $domanda) { ?>
                        <h3><?php echo "{$domanda["domanda"]}"; ?></h3>
                    <?php } ?>
                </div>

                <div class="paragrafo">
                    <?php foreach ($faqsCinque as $risposta) { ?>
                        <p><?php echo "{$risposta["risposta"]}"; ?></p>
                    <?php } ?>
                </div>

                <div class="titolo">
                    <?php foreach ($faqsSei as $domanda) { ?>
                        <h3><?php echo "{$domanda["domanda"]}"; ?></h3>
                    <?php } ?>
                </div>

                <div class="paragrafo">
                    <?php foreach ($faqsSei as $risposta) { ?>
                        <p><?php echo "{$risposta["risposta"]}"; ?></p>
                    <?php } ?>
                </div>
